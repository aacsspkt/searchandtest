...
export async function getOrCreateAssociatedTokenAccount(
	...
	const accountInfo = await connection.getAccountInfo(associatedToken, commitment);
	if (!accountInfo) {
...
export async function syncNative(connection: Connection, payer: Signer, ownerNativeMintAccount: PublicKey) {
